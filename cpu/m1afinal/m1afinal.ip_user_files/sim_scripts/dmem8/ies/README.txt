...
#
# Generated by export_simulation on Sun Dec 18 15:36:42 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './dmem8.sh' script.
...
./dmem8.sh -noclean_files

For more information on the script, please type './dmem8.sh -help'.
