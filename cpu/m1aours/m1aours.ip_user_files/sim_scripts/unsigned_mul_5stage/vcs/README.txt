...
#
# Generated by export_simulation on Sun Nov 27 15:06:00 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './unsigned_mul_5stage.sh' script.

./unsigned_mul_5stage.sh -reset_run
...
./unsigned_mul_5stage.sh -noclean_files

For more information on the script, please type './unsigned_mul_5stage.sh -help'.
