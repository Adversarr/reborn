...
#
# Generated by export_simulation on Sun Nov 27 15:05:21 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './signed_mult_5stage.sh' script.

./signed_mult_5stage.sh -reset_run
...
./signed_mult_5stage.sh -noclean_files

For more information on the script, please type './signed_mult_5stage.sh -help'.
